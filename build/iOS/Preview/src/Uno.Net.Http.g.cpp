...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#2
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno#1
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno#2
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#6
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno
// --------------------------------------------------------
...
uClassType* HttpMessageCache_typeof()
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno");
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#1
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#3
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#4
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#5
// ----------------------------------------------------------
...
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[25/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(200), ::STRINGS[38/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(201), ::STRINGS[39/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(202), ::STRINGS[40/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(203), ::STRINGS[41/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(204), ::STRINGS[42/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(205), ::STRINGS[43/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(206), ::STRINGS[44/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[25/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(300), ::STRINGS[45/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(301), ::STRINGS[46/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(302), ::STRINGS[47/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(303), ::STRINGS[48/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(304), ::STRINGS[49/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(305), ::STRINGS[50/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(307), ::STRINGS[51/*"Temporary R...*/]), collection3);
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno#3
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno#4
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#7
// ----------------------------------------------------------
...
uType* Uri_typeof()
{
    ...
    ::STRINGS[81] = uString::Const("uriString");
    ::STRINGS[82] = uString::Const("The length of uriString exceeds 65519 characters.");
    ::TYPES[3] = ::g::Uno::String_typeof();
    ::TYPES[26] = ::g::Uno::Net::Http::SchemeParserResult_typeof();
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[9] = ::g::Uno::Net::Http::HostInfo_typeof();
...
void Uri::ctor_(uString* uriString)
{
    ...
    if (::g::Uno::String::IsNullOrEmpty(uriString))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[81/*"uriString"*/]));

    uriString = ::g::Uno::String::Trim(uPtr(uriString));

    if (uriString->Length() > 65519)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[82/*"The length ...*/]));
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#8
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/$.uno#9
// ----------------------------------------------------------
...
static void UriScheme__cctor__fn(uType* __type)
{
    ...
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[86/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[87/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[88/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[89/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[90/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[91/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[92/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[93/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[94/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[95/*"news"*/]), collection1);
}
...
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    if (UriScheme::_defaultPorts() == NULL)
    {
        ...
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[90/*"file"*/], uCRef<int>(-1));
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.20/UriParsers/$.uno#5
// ---------------------------------------------------------------------
