...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/Internal/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/Internal/$.uno#1
// --------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.Internal.RectExtensions", "MoveRectInsideRect(Uno.Rect,Uno.Rect)");
...
{
    uStackFrame __("Fuse.Controls.Internal.RectExtensions", "MoveRectToContainRect(Uno.Rect,Uno.Rect)");
    ::g::Uno::Float2 pos = a.Position();
    float newX = pos.X;
    float newY = pos.Y;
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/Internal/$.uno#2
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/Internal/$.uno#3
// --------------------------------------------------------------------
...
// public int get_EndIndex() [instance] :350
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/Internal/$.uno#4
// --------------------------------------------------------------------
...
// public int BoundsToPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float p) :504
...
// public int BoundsToPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float p) [instance] :504
