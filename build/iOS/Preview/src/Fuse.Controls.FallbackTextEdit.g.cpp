...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno#3
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno#2
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno#1
// ----------------------------------------------------------------------------
...
// private float2 ControlToWindow(float2 p) :1100
...
// private void HandleLeftArrow(Fuse.Input.KeyPressedArgs args) :1425
...
// private void HandleRightArrow(Fuse.Input.KeyPressedArgs args) :1458
...
// private void InvalidateLineCacheLayout() :898
...
// private void OnGotFocus(object sender, Fuse.Input.FocusGainedArgs args) :1130
...
// private void OnKeyPressed(object sender, Fuse.Input.KeyPressedArgs args) :1296
...
// private void OnLostCapture() :1166
void TextEditVisual__OnLostCapture_fn(TextEditVisual* __this)
{
    __this->OnLostCapture();
}

// private void OnLostFocus(object sender, Fuse.Input.FocusLostArgs args) :1143
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs c) :1195
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) :1176
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) :1224
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnRooted()");
    ::g::Fuse::UpdateManager::AddAction(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)TextEditVisual__Update_fn, __this), 0);
    ::g::Fuse::Controls::Graphics::ControlVisual__OnRooted_fn(__this);
}

// private void OnTextEdited() :903
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnUnrooted()");
    ::g::Fuse::UpdateManager::RemoveAction(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)TextEditVisual__Update_fn, __this), 0);
...
// private void ResetWindowPosition() :1042
void TextEditVisual__ResetWindowPosition_fn(TextEditVisual* __this)
{
    __this->ResetWindowPosition();
}

// private void Select(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos, bool shouldSelect) :1491
...
// public void SelectAll() :914
void TextEditVisual__SelectAll_fn(TextEditVisual* __this)
{
    __this->SelectAll();
}

// public string get_SelectedText() :849
void TextEditVisual__get_SelectedText_fn(TextEditVisual* __this, uString** __retval)
{
    *__retval = __this->SelectedText();
}

// private void SelectFunc(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos) :1503
...
// private void SetCaretPos(float2 p) :1058
...
// private void StartSelection(float2 windowPoint) :1242
...
// private float2 WindowToTextBounds(float2 p) :1110
...
// public TextEditVisual() [instance] :851
...
// private void ClearPasswordReveal() [instance] :1289
...
// private float2 ControlToTextBounds(float2 p) [instance] :1120
...
// private float2 ControlToWindow(float2 p) [instance] :1100
...
// private void HandleLeftArrow(Fuse.Input.KeyPressedArgs args) [instance] :1425
...
// private void HandleRightArrow(Fuse.Input.KeyPressedArgs args) [instance] :1458
...
// private void InvalidateLineCacheLayout() [instance] :898
...
// private void MoveSelection(float2 windowPoint) [instance] :1251
...
// private void OnGotFocus(object sender, Fuse.Input.FocusGainedArgs args) [instance] :1130
...
// private void OnKeyPressed(object sender, Fuse.Input.KeyPressedArgs args) [instance] :1296
...
// private void OnLostCapture() [instance] :1166
...
// private void OnLostFocus(object sender, Fuse.Input.FocusLostArgs args) [instance] :1143
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs c) [instance] :1195
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) [instance] :1176
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) [instance] :1224
...
// private void OnTextEdited() [instance] :903
...
// private void ResetWindowPosition() [instance] :1042
...
// private void Select(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos, bool shouldSelect) [instance] :1491
...
// public void SelectAll() [instance] :914
...
// public string get_SelectedText() [instance] :849
...
// private void SelectFunc(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos) [instance] :1503
...
// private void SetCaretPos(float2 p) [instance] :1058
void TextEditVisual::SetCaretPos(::g::Uno::Float2 p)
{
    ...
    ::g::Fuse::Controls::TextEdit* ret43;
    float wrapWidth = ActualSize().X;
    ::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo = CreateWrapInfo(wrapWidth, true);
    float textBoundsWidth = GetClampedTextBoundsSize(wrapInfo).X;
    _caretPosition = uPtr(_lineCache)->BoundsToTextPos(wrapInfo, uPtr((::g::Fuse::Controls::Graphics::ControlVisual__get_Control_fn(this, &ret43), ret43))->TextAlignment(), textBoundsWidth, ControlToTextBounds(p));
    BringCaretIntoView(wrapInfo, textBoundsWidth);
    ResetCaretBlink();
}
...
// private void StartSelection(float2 windowPoint) [instance] :1242
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "Update()");
...
// private float2 WindowToTextBounds(float2 p) [instance] :1110
...
// public TextEditVisual New() [static] :851
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno#4
// ----------------------------------------------------------------------------
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1578
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1578
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) :1720
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :1720
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.14/FallbackTextEdit/$.uno#5
// ----------------------------------------------------------------------------
...
// public TextWindow(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :1742
...
// public TextWindow New(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :1742
...
// public TextWindow(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [instance] :1742
...
// public TextWindow New(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [static] :1742
