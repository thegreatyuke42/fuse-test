...
// /usr/local/share/uno/Packages/Outracks.Simulator.Reflection.Uno/0.0.0/$.uno#1
// -----------------------------------------------------------------------------
...
DelegateReflection_type* DelegateReflection_typeof()
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[8] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Parameter_typeof(), ::g::Uno::String_typeof());
    ...
    ::TYPES[11] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Parameter_typeof(), ::g::Uno::String_typeof());
    ::TYPES[12] = ::g::Uno::Func2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[13] = ::g::Uno::Func2_typeof()->MakeType(uObject_typeof(), ::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[14] = ::g::Uno::Func2_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[15] = ::g::Uno::Func2_typeof()->MakeType(uObject_typeof(), ::g::Uno::String_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[16] = ::g::Outracks::Simulator::Bytecode::Parameter_typeof();
    type->SetInterfaces(
