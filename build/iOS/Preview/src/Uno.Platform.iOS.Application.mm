// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Platform/$.uno#3'.
...
void Application::DispatchDelayedLocalNotifications(int state)
{
    ...
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[5/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedLocalNotifications_fn));
}
...
void Application::OnReceivedLocalNotification(uString* notification)
{
    ...
    else
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[5/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Application__DispatchDelayedLocalNotifications_fn));
    }
}
