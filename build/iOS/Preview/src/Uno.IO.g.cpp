...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#1
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#2
// -------------------------------------------------------------------
...
static void Bundle__cctor__fn(uType* __type)
{
    ...
    int index2;
    int length3;
    Bundle::_bundles_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[7/*Uno.Collections.Dictionary<string, Uno.IO.Bundle>*/]));
    Bundle::_allFiles_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[8/*Uno.Collections.List<Uno.IO.BundleFile>*/]));

    for (array1 = ::g::Uno::String::Split(uPtr(::g::Uno::IO::BundleFile::New1(Bundle::New1(NULL), ::STRINGS[2/*"bundle"*/], ::STRINGS[2/*"bundle"*/])->ReadAllText()), uArray::Init<int>(::TYPES[9/*char[]*/], 1, 10)), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        uString* line = uPtr(array1)->Strong<uString*>(index2);
        uArray* parts = ::g::Uno::String::Split(uPtr(line), uArray::Init<int>(::TYPES[9/*char[]*/], 1, ':'));
...
uType* Bundle_typeof()
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), Bundle_typeof());
    ::TYPES[8] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[9] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[10] = ::g::Uno::String_typeof()->Array();
    ::TYPES[11] = ::g::Uno::Delegate_typeof();
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[13] = uObject_typeof();
    ::TYPES[14] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[15] = ::g::Uno::IO::BundleFile_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[17] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(Bundle_typeof());
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(8,
        ...
        new uFunction("get_Bundles", NULL, (void*)Bundle__get_Bundles_fn, 0, true, ::g::Uno::Collections::IEnumerable_typeof()->MakeType(Bundle_typeof()), 0),
...
// public static Uno.Collections.IEnumerable<Uno.IO.Bundle> get_Bundles() :841
void Bundle__get_Bundles_fn(uObject** __retval)
{
    *__retval = Bundle::Bundles();
}
...
void Bundle::ctor_(uString* packageName)
{
    ...
    _files = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[8/*Uno.Collections.List<Uno.IO.BundleFile>*/]));
...
void Bundle::add_Created(uDelegate* value)
{
    ...
    Created1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Created1, value), ::TYPES[12/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
void Bundle::remove_Created(uDelegate* value)
{
    ...
    Created1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Created1, value), ::TYPES[12/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
::g::Uno::IO::BundleFile* Bundle::GetFile(uString* filename)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::IO::BundleFile*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_files), &ret7), ret7); enum4.MoveNext(::TYPES[14/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]); )
    {
        ::g::Uno::IO::BundleFile* f = enum4.Current(::TYPES[14/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]);
...
// public static Uno.Collections.IEnumerable<Uno.IO.Bundle> get_Bundles() [static] :841
uObject* Bundle::Bundles()
{
    uStackFrame __("Uno.IO.Bundle", "get_Bundles()");
    Bundle_typeof()->Init();
    return (uObject*)((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(Bundle::_bundles())->Values());
}
// }
...
uType* BundleFile_typeof()
{
    ...
    ::TYPES[0] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[19] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::Byte_typeof());
    ::TYPES[11] = ::g::Uno::Delegate_typeof();
...
uArray* BundleFile::ReadAllBytes()
{
    ...
    if (_bytes != NULL)
    {
        ...
        ::g::Uno::Array::Copy1(::TYPES[19/*Uno.Array.Copy<byte>*/], _bytes, result, result->Length());
        return result;
    }
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#4
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#5
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#11
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#6
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#7
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#10
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#12
// --------------------------------------------------------------------
...
void MemoryStream::ResizeTo(int newSize)
{
    ...
    ::g::Uno::Array::Copy1(::TYPES[19/*Uno.Array.Copy<byte>*/], _buffer, newBuffer, uPtr(_buffer)->Length());
    _buffer = newBuffer;
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#13
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#14
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#15
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#16
// --------------------------------------------------------------------
...
::g::Uno::IO::TextReader_type* StreamReader_typeof()
{
    ...
    ::TYPES[22] = ::g::Uno::Text::Encoding_typeof();
    ::TYPES[0] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[9] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[1] = ::g::Uno::Int_typeof();
    type->SetInterfaces(
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#17
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#19
// --------------------------------------------------------------------
...
::g::Uno::IO::TextWriter_type* StringWriter_typeof()
{
    ...
    ::TYPES[9] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[21] = ::g::Uno::Bool_typeof();
    ::TYPES[23] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::TextWriter_type, interface0));
    type->SetFields(0,
...
void StringWriter__Write3_fn(StringWriter* __this, uArray* buffer, int* index, int* count)
{
    ...
    if (count_ >= 256)
    {
        uArray* array = uArray::New(::TYPES[9/*char[]*/], count_);
        ::g::Uno::Array::Copy(::TYPES[23/*Uno.Array.Copy<char>*/], buffer, index_, array, 0, count_);
        uPtr(__this->_stringBuilder)->Append(array);
    }
    else
    {
        ::g::Uno::Array::Copy(::TYPES[23/*Uno.Array.Copy<char>*/], buffer, index_, __this->_buffer, __this->_index, count_);
...
void StringWriter::ctor_1()
{
    ...
    _open = true;
    _buffer = uArray::New(::TYPES[9/*char[]*/], 256);
    _index = 0;
}
...
void StringWriter::WriteBuffer()
{
    ...
    uArray* array = uArray::New(::TYPES[9/*char[]*/], _index);
    ::g::Uno::Array::Copy(::TYPES[23/*Uno.Array.Copy<char>*/], _buffer, 0, array, 0, _index);
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#20
// --------------------------------------------------------------------
...
TextReader_type* TextReader_typeof()
{
    ...
    ::TYPES[13] = uObject_typeof();
    ::TYPES[24] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Char_typeof());
    ::TYPES[5] = ::g::Uno::Char_typeof();
    type->SetInterfaces(
...
uString* TextReader::ReadLine()
{
    ...
    ::g::Uno::Collections::List* buffer = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[24/*Uno.Collections.List<char>*/], 16);
    int symbol = 0;
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/IO/$.uno#21
// --------------------------------------------------------------------
...
void TextWriter::Write(bool value)
{
    ...
    bool value_ = value;
    Write9(::g::Uno::Bool::ToString(value_, ::TYPES[21/*bool*/]));
}
...
void TextWriter::Write4(double value)
{
    ...
    double value_ = value;
    Write9(::g::Uno::Double::ToString(value_, ::TYPES[25/*double*/]));
}
...
void TextWriter::Write5(float value)
{
    ...
    float value_ = value;
    Write9(::g::Uno::Float::ToString(value_, ::TYPES[26/*float*/]));
}
...
void TextWriter::Write7(int64_t value)
{
    ...
    int64_t value_ = value;
    Write9(::g::Uno::Long::ToString(value_, ::TYPES[20/*long*/]));
}
...
void TextWriter::Write12(uint64_t value)
{
    ...
    Write9(::g::Uno::ULong::ToString(value_, ::TYPES[27/*ulong*/]));
}
