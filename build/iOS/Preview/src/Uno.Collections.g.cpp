...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.14/Internal/$.uno#1
// ---------------------------------------------------------------
...
uClassType* EnumerableExtensions_typeof()
{
    ...
    type->Reflection.SetFunctions(12,
        ...
        new uFunction("Last`1", type, (void*)EnumerableExtensions__Last_fn, 0, true, type->U(0), 1, ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0))),
...
// public static T Last<T>(Uno.Collections.IEnumerable<T> self) :142
void EnumerableExtensions__Last_fn(uType* __type, uObject* self, uTRef __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[7/*Uno.Collections.IEnumerator`1*/]->MakeType(__type->U(0)),
    };
    uStackFrame __("Uno.Collections.EnumerableExtensions", "Last`1(Uno.Collections.IEnumerable<T>)");
    uT ret11(__types[0], U_ALLOCA(__types[0]->ValueSize));
    uT tmp(__types[0], U_ALLOCA(__types[0]->ValueSize));
    uT item(__types[0], U_ALLOCA(__types[0]->ValueSize));
    ;
    bool any = false;
    tmp = uT(__types[0], U_ALLOCA(__types[0]->ValueSize));

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(self), ::TYPES[17/*Uno.Collections.IEnumerable`1*/]->MakeType(__types[0]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        item = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), __types[1]), &ret11), ret11);
        tmp = item;
        any = true;
    }
    ...
    return __retval.Store(tmp), void();
}
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#9
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#11
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#1
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#10
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#13
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#2
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#3
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#4
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#5
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#6
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#8
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Collections/0.27.3/Extensions/$.uno#4
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.20/Source/Uno/Collections/$.uno#12
// -----------------------------------------------------------------------------
