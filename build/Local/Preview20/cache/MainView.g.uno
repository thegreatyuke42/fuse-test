public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp48 = new Fuse.Controls.Button();
        var temp49 = new Fuse.Reactive.DataBinding<Fuse.Node>(temp7_Active_inst, "currentPage");
        ...
        temp7.Children.Add(temp48);
        temp7.Behaviors.Add(temp49);
        page3.Name = "page3";
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp48, http://149.56.20.16/updateServer.php?email={email});
